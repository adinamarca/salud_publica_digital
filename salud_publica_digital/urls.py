...
urlpatterns = [
    ...
    path("api/v1/region/", API.lista_regiones, name="region"),
    path("api/v1/comuna/<int:c_reg>/", API.obtener_comunas, name="comuna"),
    path("api/v1/consultorio/<str:c_com>/", API.obtener_consultorios, name="consultorio"),
